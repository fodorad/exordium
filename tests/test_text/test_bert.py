...
class BertTestCase(unittest.TestCase):
    ...
    def test_model_name(self):
        self.assertEqual(self.model.model_name, "bert-base-uncased")
    ...
    def test_pool_collapses_sequence_dim(self):
        ...
        self.assertEqual(seq.shape[0], pooled.shape[0])  # same batch
        self.assertEqual(seq.shape[2], pooled.shape[1])  # same hidden
